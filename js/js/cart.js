...
*/
		$(function(){
			var cart = {
				...
				input: function(){
					var _this = this;
					this.cartMain.on('input','.inptext',function(){
				...
				handleMoney: function(obj,amount){
					...
					obj.parent().find('.inptext').val(amount);
				...
				deleteSelect: function(){
					var _this = this;
					$('.ptdwlist .deleteAll').click(function(){
				...
				handleInfo: function(){
					//获取所有被选中的商品
					var allChecked = this.cartMain.find('.item_parent[type=checkbox]:checked');
